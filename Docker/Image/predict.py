...
def get_prediction(img_path):
    backbone = "weights/backbone_Imagenet.pth"
    classifier = "weights/classifier_imagenet.pth"
    batch_means = "weights/batch_means_imageNet.pth"
    beta_parameters = "weights/beta_parameters_imagenet.pth"
    model = InferenceModelImage(backbone, classifier, batch_means, beta_parameters)
